...
export const Banner = ({ viewModel }) => {
    ...
    return (<div className="bg-card rounded-lg p-6 shadow-md border">
      {loading ? (<div className="flex flex-col md:flex-row justify-center items-center md:items-center gap-4">
          <Loading variant="spinner" size="lg" message="Loading..."/>
        </div>) : (<>
          {pair ? (<div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
      ...
      {error && (<div className="mt-4 animate-fade-in">
